...
print(f"🔥 Training SASRec++ (SOTA) sur : {device}")

batch_size = int(model_cfg.get("batch_size", 4096))
max_len = int(model_cfg.get("max_len", 50)) # Historique Long
...
best_model_path = "../checkpoints/SASRec_Enh_best.pth"
...
for epoch in range(epochs):
    ...
    for batch_dict, labels in train_loader:
        ...
        # Clip grad pour stabiliser Transformer

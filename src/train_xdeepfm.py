...
print(f"🔥 Training xDeepFM (SOTA Interactions) sur : {device}")
...
# Scheduler OneCycle (Target 0.01)
# Note : xDeepFM a beaucoup de paramètres dans le CIN, donc un LR de 0.01 est un bon stress-test
...
best_model_path = "../checkpoints/xDeepFM_best.pth"
...
for epoch in range(epochs):
    ...
    for batch_dict, labels in train_loader:
        ...
        # Gradient Clipping (Important pour CIN qui peut exploser)

...
from model_sasrec import build_model
from utils import set_seed, compute_auc

config_path = "../config/sasrec_config.yaml"
if not os.path.exists(config_path): config_path = "config/sasrec_config.yaml"
...
print(f"🔥 Training SASRec (Sequential) sur : {device}")
...
best_model_path = "../checkpoints/SASRec_best.pth"

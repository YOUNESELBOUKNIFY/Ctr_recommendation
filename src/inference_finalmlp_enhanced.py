...
from model_finalmlp_enhanced import build_model
...
# Run
# ========================
config_path = "../config/finalmlp_enhanced_config.yaml"
if not os.path.exists(config_path): config_path = "config/finalmlp_enhanced_config.yaml"
...
print("Construction FinalMLP Enhanced...")
model = build_model(None, model_cfg)

checkpoint_path = "../checkpoints/FinalMLP_Enh_best.pth"
if not os.path.exists(checkpoint_path): checkpoint_path = "checkpoints/FinalMLP_Enh_best.pth"
...
sub.to_csv("prediction_finalmlp_enh.csv", index=False)
with zipfile.ZipFile("submission_finalmlp_enh.zip", 'w', zipfile.ZIP_DEFLATED) as zf:
    zf.write("prediction_finalmlp_enh.csv")
print("✅ Terminé !")
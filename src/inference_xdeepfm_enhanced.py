...
print("Construction xDeepFM Enhanced...")
model = build_model(None, model_cfg)

checkpoint_path = "../checkpoints/xDeepFM_Enh_best.pth"
if not os.path.exists(checkpoint_path): checkpoint_path = "checkpoints/xDeepFM_Enh_best.pth"
...
sub.to_csv("prediction_xdeepfm_enh.csv", index=False)
with zipfile.ZipFile("submission_xdeepfm_enh.zip", 'w', zipfile.ZIP_DEFLATED) as zf:
    zf.write("prediction_xdeepfm_enh.csv")
print("✅ Terminé !")
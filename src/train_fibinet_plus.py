...
if not os.path.exists(config_path): config_path = "config/fibinet_plus_config.yaml"
...
print(f"🔥 Training FiBiNET++ (Hybrid) sur : {device}")
...
# SCHEDULER: Pic à 0.005 (10x le LR de base)
# C'est un peu plus conservateur que 0.01 pour stabiliser l'Attention et le CrossNet
...
best_model_path = "../checkpoints/FiBiNET_Plus_best.pth"
